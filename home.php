...
$search = $_GET['search'] ?? '';
$stmt = $pdo->prepare("SELECT * FROM books WHERE titolo LIKE :search");
$stmt->execute([
    'search' => "%$search%",
...
<body>
    ...
    <nav class="navbar bg-body-tertiary red myn">
        <div class="container">
            <a href="http://localhost/S1L5php/home.php " class="text-decoration-none" > <span
            ...
            <div class='d-flex gap-2'>
                ...
                <a href="logout.php" class="fw-bold text-primary fs-5">Esci</a>

                <!-- Modal -->
                <div class="modal fade" id="exampleModal" tabhome="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                ...
                <?php foreach ($array as $key => $row): ?>
                    <div class="col col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2">
                        ...
                        <div class="modal fade "
                            ...
                            tabhome="-1" aria-labelledby="exampleModalLabel<?= $key ?>" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
